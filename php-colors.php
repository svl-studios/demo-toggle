...
class Color {
	 ...
	 * @return boolean
	 */
	public function is_light( $color = false, int $lighterThan = 130 ): bool {
		// Get our color
	 ...
	 */
	public function get_css_gradient( $amount = self::DEFAULT_ADJUST, $vintageBrowsers = false, $suffix = '', $prefix = '' ): string {
